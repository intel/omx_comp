#define LOG_NDEBUG 0
#define LOG_TAG "mpeg4encoder-test"
#include <utils/Log.h>
...
class MPEG4CodecInfoObserver : public CodecInfoObserver {
	public:
		MPEG4CodecInfoObserver() {};
		~MPEG4CodecInfoObserver() {};
	protected:
...
int main(int argc, char** argv)
{
	...
	fileout = fopen("/sdcard/dump.mpeg4", "wb");
	assert(fileout!=NULL);
