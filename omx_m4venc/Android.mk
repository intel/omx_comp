...
LOCAL_SRC_FILES := \
	src/MPEG4Encoder.cpp \
	src/OMXMPEG4Component.cpp

LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := libwrs_omxil_intel_mrst_psb_stub_ve_mpeg4
...
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE := MPEG4Encoder-test

LOCAL_STATIC_LIBRARIES :=

LOCAL_SHARED_LIBRARIES := libwrs_omxil_base_encoder libva libutils libwrs_omxil_intel_mrst_psb_stub_ve_mpeg4
