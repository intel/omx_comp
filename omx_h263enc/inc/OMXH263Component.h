#ifndef __WRS_OMXIL_INTEL_MRST_PSB_H263
#define __WRS_OMXIL_INTEL_MRST_PSB_H263
...
private:
    ...
    OMX_ERRORTYPE ChangeH263EncoderConfigWithPortParam(CodecConfig* pconfig,
                                         PortVideo *port);
