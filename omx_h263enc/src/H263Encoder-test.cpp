#define LOG_NDEBUG 0
#define LOG_TAG "H263encoder-test"
#include <utils/Log.h>
...
class H263CodecInfoObserver : public CodecInfoObserver
{
    public:
	H263CodecInfoObserver() {};
	~H263CodecInfoObserver() {};
    protected:
...
int main(int argc, char** argv)
{
	...
	fileout = fopen("/sdcard/dump.h263", "wb");
	assert(fileout!=NULL);
