#ifndef __WRS_OMXIL_INTEL_MRST_PSB_AVC
#define __WRS_OMXIL_INTEL_MRST_PSB_AVC
...
private:
    ...
    OMX_ERRORTYPE ChangeAVCEncoderConfigWithPortParam(CodecConfig* pconfig, PortVideo *port);

    NalStartCodeType DetectStartCodeType(OMX_U8* buf, OMX_U32 len);

    OMX_ERRORTYPE SplitNalByStartCode(OMX_U8* buf, OMX_U32 len,
		    OMX_U8** nalbuf, OMX_U32* nallen, NalStartCodeType startcode_type);
